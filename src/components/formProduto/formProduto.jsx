...
export function FormNewProduto() {
    ...
    return (
        <form action="" className="newProduto__form">
            <div className="form__top">
                ...
                <div className="form__column">
                    <div className="form__descriptionProduct">
                        ...
                        <input type="text" id="description__product" className="description__input" />
                    </div>
            ...
            <Link className="add-product" to="/">Adicionar Produto</Link>
        </form>
    );
}